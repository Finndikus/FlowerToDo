...
import { Plus, X, Edit2, Check, Download, Upload } from "lucide-react";
...
export const ListTabs: React.FC = () => {
    ...
    return (
        <div className="flex items-center gap-2 w-full overflow-x-auto no-scrollbar">
            {/* Left side: Lists and Add button */}
            <div className="flex items-center gap-2 shrink-0">
                {lists.map((list) => (
                    <div
                        key={list.id}
                        className={cn(
                            "group flex items-center gap-2 px-3 py-1.5 rounded-lg border transition-all cursor-pointer whitespace-nowrap",
